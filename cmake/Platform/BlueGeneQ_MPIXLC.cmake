...
if ( CMAKE_BUILD_TYPE STREQUAL "Debug" )
  set( OpenMP_C_FLAGS "-qsmp=omp:noopt" CACHE STRING "Compiler flag for OpenMP parallelization" FORCE )
  set( OpenMP_CXX_FLAGS "-qsmp=omp:noopt" CACHE STRING "Compiler flag for OpenMP parallelization" FORCE )
else ()
