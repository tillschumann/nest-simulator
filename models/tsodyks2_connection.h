...
private:
  float weight_;
  float U_;       //!< unit increment of a facilitating synapse
  float u_;       //!< dynamic value of probability of release
  float x_;       //!< current fraction of the synaptic weight
  float tau_rec_; //!< [ms] time constant for recovery
  float tau_fac_; //!< [ms] time constant for facilitation
};
