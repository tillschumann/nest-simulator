...
extern const Name coeff_ex; //!< tau_lcm=coeff_ex*tau_ex (precise timing neurons
                            //!< (Brette 2007))
extern const Name coeff_in; //!< tau_lcm=coeff_in*tau_in (precise timing neurons
                            //!< (Brette 2007))
extern const Name coeff_m;  //!< tau_lcm=coeff_m*tau_m (precise timing neurons
                            //!< (Brette 2007))
...
extern const Name Inact_p;   //!< Specific to Hodgkin Huxley models with gap
                             //!< junctions
...
extern const Name V_peak;  //!< Spike detection threshold
                           //!< (Brette & Gerstner 2005)
extern const Name V_reset; //!< Reset potential
extern const Name V_th;    //!< Threshold
extern const Name V_th_alpha_1; //!< Specific to Kobayashi, Tsubo,
                                //!< Shinomoto 2009
extern const Name V_th_alpha_2; //!< Specific to Kobayashi, Tsubo,
                                //!< Shinomoto 2009
extern const Name V_th_v;       //!< Specific to amat2_*
extern const Name vals_eta;     //!< Specific to population point process model
                                //!< (pp_pop_psc_delta)
