...
using namespace h5import;
  ...
  H5SynapseFile::H5SynapseFile( const std::string& path,
  ...
  H5SynapseFile::~H5SynapseFile()
    {
     ...
     void H5SynapseFile::loadNeuronLinks()
     {
     ...
     void H5SynapseFile::removeNotNeededNeuronLinks()
    {
    ...
    void H5SynapseFile::integrateSourceNeurons( SynapseBuffer& synapses, const H5View& view )
    {
     ...
     *
     */
    void H5SynapseFile::readblock( SynapseBuffer& synapses, H5View& dataspace_view )
    {
